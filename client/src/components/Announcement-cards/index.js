...
function Card({ title, description, price, id, date }) {
  ...
  return (
    ...
    <div className="card mt-3 ms-3 me-3 col-md-2 shadow-md p-1 mb-1 bg-body rounded " >
         {
          image.map( (img,i)=>{
      ...
      <Link onClick={getItemID} to="/announcement-info" type="submit"><a className="card-link">Ver más</a></Link>
