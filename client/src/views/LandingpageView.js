...
import LCard from '../components/Landing-cards';
    ...
    <div className="">
      ...
      <nav className="navbar navbar-dark bg-dark container-fluid row">
        <div className="col-lg-4 d-flex justify-content-start" >
          ...
          {/* <a class="text-white bg-dark" type="submit" onClick={handleReset}></a> */}
        </div>
        ...
        <div className="col-lg-4 " >
          <Link to="/login" className="btn btn-primary mb-3 App-button-blue float-end" type="submit">Iniciar Sesión</Link>
          <Link to="/signup" className="btn btn-primary mb-3 App-button  float-end" type="submit">Registrarse</Link>
        </div>
      </nav>
            ...
            <div className="col " >
              <div className="row" >
                {publications.length > 0 && publications.map(publication => (
                  <LCard title={publication.title} description={publication.description} price={publication.price} id={publication.id_publication} date={publication.date_publication}></LCard>
                ))}
              </div>
              <div>
